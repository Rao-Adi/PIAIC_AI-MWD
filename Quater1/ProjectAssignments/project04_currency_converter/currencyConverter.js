...
function convertCurrency() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { amount, fromCurrency, toCurrency } = yield promptForConversionData();
            const exchangeRate = yield getExchangeRate(fromCurrency, toCurrency);
...
function promptForConversionData() {
    return __awaiter(this, void 0, void 0, function* () {
...
function getExchangeRate(fromCurrency, toCurrency) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.get(`https://api.exchangerate-api.com/v4/latest/${fromCurrency}`);
